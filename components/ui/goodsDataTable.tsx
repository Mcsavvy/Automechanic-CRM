...
export const DataTable: FC<DataTableProps> = ({ data, headers, filters, onChangeGood, onNext, onPrev, page, pageCount, hasPrevPage, hasNextPage }) => {
        ...
        <div className="relative flex flex-col h-full w-full">
            ...
            <div className="flex flex-row items-center justify-between p-3 mx-[30px] pt-0 h-[70px]">
                <div className="flex flex-row items-center justify-start gap-3">
                    <Button variant={"outline"} onClick={onPrev} disabled={!hasPrevPage}>Prev</Button>
                    <Button variant={"outline"} onClick={onNext} disabled={!hasNextPage}>Next</Button>
                </div>
                <p>-
