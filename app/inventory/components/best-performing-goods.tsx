...
const BestPerformer: FC<Partial<BestPerformerProps>> = ({ before, after }) => {
    ...
    return (
        <div className="products md:col-span-2 border border-neu-3 md:min-h-[350px] md:h-full w-full p-4 bg-white rounded-md shadow-md ">
            ...
            <table className=" w-full overflow-scroll rounded-md mt-2">
