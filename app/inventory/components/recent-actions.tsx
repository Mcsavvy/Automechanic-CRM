    ...
    <div className="flex md:flex-row-reverse w-[100%] flex-wrap items-stretch justify-between gap-6 rounded-md">
      <div className="flex flex-col w-full md:w-[calc(40%-2em)] gap-6 h-full self-stretch">
        <ul className="flex flex-row flex-wrap items-center justify-start gap-3">
          {ctab.map(({ front, icon: Icon, link }, idx) => {
            return (
              <li
                key={idx}
                className="cursor-pointer grow bg-pri-5 text-white active:scale-95 transition-transform  flex flex-col items-center justify-center text-[12px] w-[150px] font-quicksand font-semibold p-3 shadow-md rounded-md"
                onClick={() => {
        ...
        {(clicked || isLargeScreen) && (
          <>
            <div className="rounded-md min-h-[150px] flex-grow w-full border border-neu-2 bg-white flex flex-col items-center justify-center p-3 gap-3 shadow-md">
              ...
              {(search && (
                ...
                (mvp && (
                  ...
                  >
                    <div className="flex flex-col flex-wrap items-center justify-start gap-4">
                      <p className="font-semibold text-pri-6 text-4xl font-rambla">
                        {mvp.name}
                      </p>
                      <ul className="grow flex flex-row w-full justify-center flex-wrap gap-4">
                        <li className="flex flex-row items-center justify-start gap-1">
                          <ShoppingCart strokeWidth={1.5} size={20} />{" "}
                          <span>{mvp.qtySold} sold</span>
                        </li>
                        <li className="flex flex-row items-center justify-start gap-1">
                        ...
                        <li className="flex flex-row items-center justify-start gap-1">
                          <ReceiptText strokeWidth={1.5} size={20} />{" "}
                          <span>
                            {mvp.orderCount} order
                            {mvp.orderCount > 0 ? "s" : ""}
                          </span>
                        </li>
                        <li
                          className={` text-${
                            mvp.profitPercentage >= 0 ? "green-500" : "red-500"
                  ...
                  <div>
                    <h2 className="text-xl font-bold font-rambla font-acc-7">
            ...
            <div className="rounded-md min-h-[150px] flex-grow w-full border border-neu-2 bg-white flex flex-col items-center justify-center p-3 gap-3 shadow-md">
              <p className="text-sm text-neu-8">
                Most Profitable Product (MPP)
              </p>
              {(search && (
                <LoaderPinwheel
                  size={40}
                ...
                (mpp && (
                  ...
                  >
                    <div className="flex flex-col flex-wrap items-center justify-start gap-4">
                      ...
                      <ul className="grow flex flex-row flex-wrap justify-center w-full gap-4">
                        <li className="flex flex-row items-center justify-start gap-1">
                          <ShoppingCart strokeWidth={1.5} size={20} />{" "}
                          <span>{mpp.qtySold} sold</span>
                        </li>
                        <li className="flex flex-row items-center justify-start gap-1">
                          <CircleDollarSign strokeWidth={1.5} size={20} />{" "}
                        ...
                        <li className="flex flex-row items-center justify-start gap-1">
                          <ReceiptText strokeWidth={1.5} size={20} />{" "}
                          <span>
                            {mpp.orderCount} order
                            {mpp.orderCount > 1 ? "s" : ""}
                          </span>
                        </li>
                        <li
                          className={` text-${
                            mpp.profitPercentage >= 0 ? "green-500" : "red-500"
                          } flex flex-row items-center justify-start gap-1`}
                        >
