...
const initialScopes: Scopes = {
  user: {
    allChecked: false,
    items: [
      { action: "create", label: "Create", description: "Register a new staff", checked: false },
      { action: "read", label: "Read", description: "View staff data and actions", checked: false },
      { action: "update", label: "Update", description: "Update staff details and information as well as staff roles", checked: false },
      { action: "delete", label: "Delete", description: "Deactivate a staff member's account", checked: false },
    ]
  },
  customer: {
    allChecked: false,
    items: [
      { action: "create", label: "Create", description: "Add a new client to the registry", checked: false },
      { action: "read", label: "Read", description: "View client data and actions", checked: false },
      { action: "update", label: "Update", description: "Update client information", checked: false },
      { action: "delete", label: "Delete", description: "Remove a client from the registry", checked: false },
    ]
  },
  product: {
    allChecked: false,
    items: [
      { action: "create", label: "Create", description: "List a new product", checked: false },
      { action: "read", label: "Read", description: "View product details and data", checked: false },
      { action: "update", label: "Update", description: "Mpdify product information, restock, etc", checked: false },
      { action: "delete", label: "Delete", description: "Remove a product from the virtual shelf", checked: false },
    ]
  },
  order: {
    allChecked: false,
    items: [
      { action: "create", label: "Create", description: "Create a new order for a client", checked: false },
      { action: "read", label: "Read", description: "View all available order no matter their status", checked: false },
      { action: "update", label: "Update", description: "Update an order, print invoices", checked: false },
      { action: "delete", label: "Delete", description: "Delete an order", checked: false },
    ]
  },
  payment: {
    allChecked: false,
    items: [
      { action: "create", label: "Create", description: "Record a client's payment for an order", checked: false },
      { action: "read", label: "Read", description: "View all payments made by clients", checked: false },
      { action: "update", label: "Update", description: "Record new payment details for a particular payment, correct typos", checked: false },
      { action: "delete", label: "Delete", description: "Remove a payment record from the tellers for one reason or the other", checked: false },
    ]
  },
  permission: {
    allChecked: false,
    items: [
      { action: "read", label: "Read", description: "View all roles and the permissions that they have", checked: false },
      { action: "update", label: "Update", description: "Modify a role's data or the permissions associated with it", checked: false },
    ]
  },
  log: {
    allChecked: false,
    items: [
      { action: "read", label: "Read", description: "View the logs of the all data inputs, changes and other actions", checked: false },
    ]
  }
};
