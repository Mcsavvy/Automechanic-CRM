...
export default function EditBuyerModal() {
  ...
  const [buyerId, setBuyerId] = useQueryState("buyer", {defaultValue: "", clearOnDefault: true});
  const { getBuyer, updateBuyer } = useBuyerStore(
    (state) => state
  );
